...
| [2](fase-2-tier1-indobert/) | Tier 1 Matang — IndoBERT (skor urgensi) | A | ⬜ Belum |
| [3](fase-3-tier2-ml/) | Tier 2 Matang — Klasifikasi ML (kelayakan) | A | ⬜ Belum |
| [4](fase-4-tier3-fuzzy-topsis/) | Tier 3 Matang — Fuzzy TOPSIS (ranking) | A | ⬜ Belum |
| [5](fase-5-dashboard-pengujian/) | Dashboard, Penjelasan & Instrumen Pengujian | A | ⬜ Belum |
